...
let caracteres = `Bienvenidos al curso de JS moderno`
...
let convertirMayusculas = `Bienvenidos al curso de JS moderno`
console.log(convertirMayusculas.toUpperCase());

// Método toLowerCase(): Cambia a minúsculas (Sintaxis: string.toLowerCase())
let convertirMinusculas = `Bienvenidos al curso de JS moderno`
...
console.log(recortar.trimStart());
console.log(recortar.trimEnd());
...
let reemplazar = `La señora Graham vive en un casa de color azul y tiene un automóvil de color azul`
